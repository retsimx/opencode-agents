...
> **Vendor note:** This workflow executes inline. Use `.agents/skills/architecture/SKILL.md` and its resources as the primary reference for method selection, stakeholder synthesis, and output format.
...
- `.agents/skills/architecture/resources/methodology-selection.md`
...
- `.agents/skills/architecture/resources/execution-protocol.md`
- `.agents/skills/architecture/resources/output-templates.md`
...
- `.agents/skills/architecture/resources/stakeholder-synthesis.md`
