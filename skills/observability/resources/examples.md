...
1. Invoke `/observability "set up OTel stack on k8s"`.
...
2. Invoke `/observability --investigate "5xx spike in ap-northeast-2"`.
...
1. Invoke `/observability --migrate "Fluentd to Fluent Bit"`.
