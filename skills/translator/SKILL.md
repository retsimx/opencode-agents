...
#### Layer 1: Voice Setting

The default voice is `balanced`. It can be overridden per-task.
...
If the field is missing, default to `balanced`.
...
- **Code/regex/identifiers in English.** Per i18n-guide rules, code blocks, JSON keys, file paths, regex patterns, workflow names, and system markers like `[WORKFLOW: ...]` stay verbatim.
