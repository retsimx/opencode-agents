...
| `gemini` | PASS | `inlineData` parts (base64) prepended to text prompt | Up to 14 refs supported by `gemini-2.5-flash-image` |
...
| Precheck | `IMAGE_GEMINI_MCP=1` (explicit opt-in) |
