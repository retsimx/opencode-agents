...
> **Note**: This file documents the default memory (file-based) protocol. The execution protocol (`.agents/skills/_shared/runtime/execution-protocol.md`) is included in the Task tool prompt.
