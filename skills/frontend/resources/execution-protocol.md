...
2. **Check domain checklist**: load pre-flight `docs/checklists/frontend.md` (fallback: `.agents/skills/frontend/resources/checklist.md`) and check relevant `.agents/results/bugs/`
...
4. **Budget context**: follow `.agents/skills/_shared/core/context-budget.md` (read symbols, not whole files)
...
- Follow `.agents/skills/frontend/resources/tailwind-rules.md` for styling

## Step 4: Verify
- Run `docs/checklists/frontend.md` (fallback: `.agents/skills/frontend/resources/checklist.md`) items with explicit line-number citations (e.g. `- [x] Rule: Verified path/to/Component.tsx:L35`)
...
## On Error
See `.agents/skills/frontend/resources/error-playbook.md` for recovery steps.
