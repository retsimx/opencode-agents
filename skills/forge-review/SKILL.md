...
- Ingested PR context (current-state only), including a labelled untrusted author/maintainer comments block, saved at `.agents/results/pr-context-{n}-{sessionId}.md`.
