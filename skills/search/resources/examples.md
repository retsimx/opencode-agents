...
**Input:**
```
/search --code "OAuth PKCE implementation TypeScript"
```
...
**Input:**
```
/search --strict "JWT refresh token rotation"
```
...
**Input:**
```
/search --code --gitlab "CI pipeline caching strategy"
```
...
## Example 7: Shared infrastructure call (from debug)

**Context:** debug encounters an unfamiliar error message
...
**Input:**
```
/search --docs "htmx form validation"
```
