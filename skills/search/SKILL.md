...
#### Standalone
```
/search "React Server Components streaming"
/search --docs "Next.js middleware"
/search --code "PKCE implementation"
/search --strict "JWT refresh token rotation"
```

#### Shared Infrastructure (from other skills)
Other skills reference search by specifying intent and query:
