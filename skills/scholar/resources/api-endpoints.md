...
The host `knows.dev` is currently unreachable (HTTPS times out as of 2026-04-25), so schema cannot be fetched directly. The `scholar-lint` subcommand implements rules empirically derived from production records.
